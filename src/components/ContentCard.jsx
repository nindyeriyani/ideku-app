        ...
        <section className="left-section">
          <header>
            ...
            <div className="content-info flex justify-between items-center my-5">
              <h2 className="text-2xl font-bold w-120">
          ...
          <section className="content mb-5">
            <p className="text-gray-700 text-base">
              ...
              tenetur, incidunt ut quas accusantium rem, nam iusto veritatis
              porro magnam quis eaque perspiciatis, deserunt quibusdam
              temporibus assumenda dolore expedita quod saepe culpa at eligendi
              similique. Ipsam nobis quae saepe dicta deleniti, necessitatibus
              exercitationem consectetur eligendi perferendis accusamus enim ad.
            </p>
          </section>
